...
<head>
    ...
    <link rel="stylesheet" href="doctorStyle.css?v=<?php echo time(); ?>">
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <div id="login-column" class="col-md-12" style="height: 180px; background: #113448;">
        <div class="main fixed-top text-center">

            <h3 style="color: white;">Find Doctors in your area</h3>
            <br>
            ...
            <form method="POST">
                <div class="input-group">
                    ...
                    <input type="text" name="search" id="search" class="form-control" placeholder="Enter your area">
